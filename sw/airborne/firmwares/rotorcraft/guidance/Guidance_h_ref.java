...
public class Guidance_h_ref {
	 ...
	 public static float gh_max_speed = GUIDANCE_H_REF_MAX_SPEED;
	 ...
	 public static final double GH_ZETA_OMEGA_FRAC = 10;
	 public static final double GH_OMEGA_2_FRAC = 7;
	 ...
	 public static final double GH_REF_INV_TAU_FRAC = 16;
	 ...
	 public static final double GH_SPEED_REF_FRAC = (GH_ACCEL_REF_FRAC + GH_FREQ_FRAC);

	 public static final double GH_POS_REF_FRAC = (GH_SPEED_REF_FRAC + GH_FREQ_FRAC);

...
public class Navigation {
	...
	public static int  nav_circle_radius, nav_circle_qdr, nav_circle_radians;

	public static int  nav_leg_progress;
	public static int  nav_leg_length;
	...
	public static void nav_init() {
		// convert to
		EnuCoor_f wp_tmp_float[NB_WAYPOINT] = WAYPOINTS;
...
//		static int wp_idx_last = 0;
	...
	public static void NavGlide(int _last_wp, int _wp) { 
	  int start_alt = waypoints[_last_wp].z; 
	  int diff_alt = waypoints[_wp].z - start_alt; 
	  int alt = start_alt + ((diff_alt * nav_leg_progress) / nav_leg_length); 

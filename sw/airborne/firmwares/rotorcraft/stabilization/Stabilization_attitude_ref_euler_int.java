...
public class Stabilization_attitude_ref_euler_int {
	...
	public static final int OMEGA_P =  STABILIZATION_ATTITUDE_REF_OMEGA_P;
	public static final int ZETA_P  =  STABILIZATION_ATTITUDE_REF_ZETA_P;
	...
	public static final int OMEGA_Q  = STABILIZATION_ATTITUDE_REF_OMEGA_Q;
	public static final int ZETA_Q  =  STABILIZATION_ATTITUDE_REF_ZETA_Q;
	...
	public static final int OMEGA_R  = STABILIZATION_ATTITUDE_REF_OMEGA_R;
	public static final int ZETA_R   = STABILIZATION_ATTITUDE_REF_ZETA_R;
	...
	public static void stabilization_attitude_ref_update() {
		...
		if (USE_ATTITUDE_REF){
			...
			Int32Rates accel_rate = {
					((int)(-2.*ZETA_OMEGA_P) * (stab_att_ref_rate.p >> (REF_RATE_FRAC - REF_ACCEL_FRAC)))
					>> (ZETA_OMEGA_P_RES),
					((int)(-2.*ZETA_OMEGA_Q) * (stab_att_ref_rate.q >> (REF_RATE_FRAC - REF_ACCEL_FRAC)))
					>> (ZETA_OMEGA_Q_RES),
					((int)(-2.*ZETA_OMEGA_R) * (stab_att_ref_rate.r >> (REF_RATE_FRAC - REF_ACCEL_FRAC)))
					>> (ZETA_OMEGA_R_RES) };

			Int32Rates accel_angle = {
					((int)(-OMEGA_2_P)* (ref_err.phi   >> (REF_ANGLE_FRAC - REF_ACCEL_FRAC))) >> (OMEGA_2_P_RES),
					((int)(-OMEGA_2_Q)* (ref_err.theta >> (REF_ANGLE_FRAC - REF_ACCEL_FRAC))) >> (OMEGA_2_Q_RES),
					((int)(-OMEGA_2_R)* (ref_err.psi   >> (REF_ANGLE_FRAC - REF_ACCEL_FRAC))) >> (OMEGA_2_R_RES) };

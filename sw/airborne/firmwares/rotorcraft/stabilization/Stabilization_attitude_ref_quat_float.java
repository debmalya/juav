...
public class Stabilization_attitude_ref_quat_float {
	...
	public static final  int REF_ACCEL_MAX_P =STABILIZATION_ATTITUDE_REF_MAX_PDOT;
	public static final  int REF_ACCEL_MAX_Q =STABILIZATION_ATTITUDE_REF_MAX_QDOT;
	public static final  int REF_ACCEL_MAX_R =STABILIZATION_ATTITUDE_REF_MAX_RDOT;

	public static final  int REF_RATE_MAX_P =STABILIZATION_ATTITUDE_REF_MAX_P;
	public static final  int REF_RATE_MAX_Q =STABILIZATION_ATTITUDE_REF_MAX_Q;
	public static final  int REF_RATE_MAX_R= STABILIZATION_ATTITUDE_REF_MAX_R;
